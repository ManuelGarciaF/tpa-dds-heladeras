...
public interface DespachadorDeMensajeria {
  void enviarMensaje(InstantMessageApp provider, String telephone, String message) throws InvalidTelephoneNumberException, ar.edu.utn.frba.dds.externo.InvalidTelephoneNumberException;
}
